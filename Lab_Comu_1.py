...
class Lab_Comu_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Primer Flujogama", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Primer Flujogama")
        ...
        self._amplitud_range = Range(0, 5, 100, 0, 200)
